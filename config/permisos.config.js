...
const permisos = {
  ...
  "sku:crear": NO_DEFINIDO,
  "sku:eliminar": NO_DEFINIDO,
  "sku:leer:id": NO_DEFINIDO,
  "sku:leer:termino": NO_DEFINIDO,
  "sku:leer:todo": NO_DEFINIDO,
  "sku:leer:transito": NO_DEFINIDO,
  "sku:modificar": NO_DEFINIDO,
  "sku:modificar:parte": NO_DEFINIDO,
  "sku:stock:modificar": NO_DEFINIDO,
