...
app.get("/", $("area:leer:todo"), async (req, res) => {
...
app.get("/:id", $("area:leer:id"), (req, res) => {
...
app.put("/", $("area:modificar"), (req, res) => {
...
app.delete("/:id", $("area:eliminar"), (req, res) => {
  Area.findById(req.params.id)
    .exec()
    .then(area => {
