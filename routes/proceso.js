...
app.post("/", (req, res) => {
  return new Proceso(req.body)
    ...
    .catch(err => erro(res, err, "Hubo un error guardo el proceso"))
})
...
app.get("/", async (req, res) => {
  ...
  Proceso.find()
    ...
    .catch(err => erro(res, err, "Hubo un error buscando las procesos"))
})
...
app.get("/:id", (req, res) => {
  Proceso.findById(req.params.id)
    ...
    .catch(err => erro(res, err, "Hubo un error buscando la proceso por su id"))
})
...
app.get("/buscar/:termino", async (req, res) => {
  ...
  ;["nombre", "observaciones", 'departamento.nombre'].forEach(x => $match.$or.push(b(x)))
...
app.delete("/:id", (req, res) => {
  Proceso.findById(req.params.id)
    .exec()
    .then(proceso => {
      if (!proceso) throw "No existe la proceso"
