...
const ordenSchema = new Schema({
  ...
  numeroDeOrden: {
    type: Number,
    required: [true, "El número de órden es obligatorio"],
  },
  ...
  unidad: {
    ...
    min: 0.0001,
    max: 1,
    required: [true, "La únidad de esta órden es requerida."],
  },
  piezasTeoricas: {
    type: Number,
    min: 1,
    required: [
      true,
      "Es necesario definir la cantidad esperada de esta órden.",
    ],
  },
