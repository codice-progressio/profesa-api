...
const permisos = {
  ...
  "administrador:usuario:leer": "Consultar la lista de usuarios existentes",
  "usuario:modificar":
    "Modificar datos basicos del usuario como foto de perfil y nombre",
  "administrador:usuario:crear": "Crear un usuario",
  "administrador:usuario:eliminar": "Eliminar un usuario",
  "administrador:usuario:roles": "Modificar roles del usuario",
  "upload:tipo:id": "Subir imagenes",
  "imagenes:tipo:ver": "Ver imagenes",
  "modeloCompleto:crear": "Crear un sku",
  "modeloCompleto:leer:todo": "Leer lista de sku",
  "modeloCompleto:leer:id": "Buscar sku por id",
  "modeloCompleto:leer:termino": "Buscar sku por termino",
  "modeloCompleto:eliminar": "Eliminar sku",
  "modeloCompleto:modificar": "Modificar sku",
  "modeloCompleto:leer:transito": "Leer cantidad en transito de sku",
  "modeloCompleto:stock:modificar": "Modificar stock de sku",
  "cliente:crear": "Crear un cliente",
  "cliente:leer:todo": "Ver lista de clientes",
  "cliente:leer:id": "Buscar un cliente por id",
  "cliente:leer:termino": "Buscar cliente por termino",
  "cliente:eliminar": "Eliminar cliente",
  "cliente:modificar": "Modificar un cliente",
  "departamento:crear": "Crea un departamento",
  "departamento:leer:todo": "Ver lista de departamentos",
  "departamento:leer:id": "Buscar departamento por id",
  "departamento:leer:termino": "Buscar departamento por termino",
  "departamento:modificar": "Modificar departamento",
  "departamento:eliminar": "Eliminar departamento",
  "departamento:leer:multiple": "Busar multiples departamentos por id",
  "proceso:crear": "Crear un proceso",
  "proceso:leer:todo": "Ver lista de procesos",
  "proceso:leer:id": "Buscar proceso por id",
  "proceso:leer:termino": "Buscar proceso por termino",
  "proceso:modificar": "Modificar proceso",
