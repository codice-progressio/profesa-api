...
app.get("/detalle/orden/:folio/:pedido/:orden", (req, res) => {
...
app.get("/detalle/pedido/:folio/:pedido", (req, res) => {
  Folio.findById(req.params.folio)
    .exec()
...
app.get("/detalle/folio/:folio", (req, res) => {
  Folio.findById(req.params.folio)
    .exec()
...
app.get("/reporte/paraRevision", async (req, res) => {
